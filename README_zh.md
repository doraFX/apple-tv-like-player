# 🍎 Apple TV 风格 HTML5 视频播放器

🍎 Apple TV 风格视频播放器组件
一个轻量、流畅、开箱即用的视频播放器 UI。

---

## 📖 简介

这是一个基于原生 JavaScript 的轻量级插件，可以将普通的 `<video>` 元素增强为具有 Apple TV 风格的沉浸式播放器。

无需初始化，加载即用，自动作用于页面中的所有视频元素。
...
带有 `data-atvp-ignore="1"` 的视频将不会被播放器处理。
